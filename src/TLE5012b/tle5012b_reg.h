...
#ifndef TLE5012B_TEST_TLE5012B_REG_H
#define TLE5012B_TEST_TLE5012B_REG_H
...
public:
    ...
    */
    ...
    uint16_t regMap[MAX_NUM_REG];              //!< Reg map */
...
#endif //TLE5012B_TEST_TLE5012B_REG_H
